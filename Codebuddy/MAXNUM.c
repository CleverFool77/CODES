...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <script async="" src="MAXNUM_files/analytics.js"></script><script src="MAXNUM_files/jquery.js"></script>
    <script src="MAXNUM_files/bootstrap.js"></script>
    <link href="MAXNUM_files/font-awesome.css" rel="stylesheet">
    <link rel="stylesheet" href="MAXNUM_files/bootstrap.css">
    <link rel="stylesheet" href="MAXNUM_files/default.css">
    <script src="MAXNUM_files/highlight.js"></script>
    <link rel="stylesheet" href="MAXNUM_files/header.css">
    <link rel="stylesheet" href="MAXNUM_files/viewsolution.css">
    <script src="MAXNUM_files/anal.js"></script>
...
<div class="effect2">
    <a href="https://codebuddy.co.in/"><img src="MAXNUM_files/LogoResize.png" alt="Image Not Found" class="logo2"></a>
    ...
    <a href="https://codebuddy.co.in/ranks/practice" id="headerrankings" class="rankingslabel"><i class="fa fa-trophy" style="cursor: pointer"></i> <label style="cursor: pointer">Rankings</label></a>
        ...
        <img src="MAXNUM_files/asuna.jpg" class="headerprofilepic">
    ...
    <div class="submissiondetails">
        ...
        <label>Submission time : </label> 16-06-2017 17:20 PM<small><small> IST</small></small><br>
        <label>Problem Code : </label> <a href="https://codebuddy.co.in/problems/MAXNUM">MAXNUM</a><br>
...
<span class="hljs-keyword">long</span> <span class="hljs-keyword">long</span> <span class="hljs-keyword">int</span> a,b,c;
	<span class="hljs-built_in">scanf</span>(<span class="hljs-string">"%lld"</span>,&amp;a);
	<span class="hljs-built_in">scanf</span>(<span class="hljs-string">"%lld"</span>,&amp;b);
	<span class="hljs-built_in">scanf</span>(<span class="hljs-string">"%lld"</span>,&amp;c);
	<span class="hljs-keyword">if</span>(a&gt;b&amp;&amp;a&gt;c)
	<span class="hljs-built_in">printf</span>(<span class="hljs-string">"%lld"</span>,a);
	<span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(b&gt;c&amp;&amp;b&gt;a)
	<span class="hljs-built_in">printf</span>(<span class="hljs-string">"%lld"</span>,b);
	<span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(c&gt;a&amp;&amp;c&gt;b)
	<span class="hljs-built_in">printf</span>(<span class="hljs-string">"%lld"</span>,c);
}
</code></pre>
    </div>
    ...
    <footer id="footer" class="footercontainer" style="top: 27.3333px;">
    ...
    <script src="MAXNUM_files/email-decode.js"></script><script type="text/javascript" language="javascript">
