...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <script async="" src="HELLO_files/analytics.js"></script><script src="HELLO_files/jquery.js"></script>
    <script src="HELLO_files/bootstrap.js"></script>
    <link href="HELLO_files/font-awesome.css" rel="stylesheet">
    <link rel="stylesheet" href="HELLO_files/bootstrap.css">
    <link rel="stylesheet" href="HELLO_files/default.css">
    <script src="HELLO_files/highlight.js"></script>
    <link rel="stylesheet" href="HELLO_files/header.css">
    <link rel="stylesheet" href="HELLO_files/viewsolution.css">
    <script src="HELLO_files/anal.js"></script>
...
<div class="effect2">
    <a href="https://codebuddy.co.in/"><img src="HELLO_files/LogoResize.png" alt="Image Not Found" class="logo2"></a>
    ...
    <a href="https://codebuddy.co.in/ranks/practice" id="headerrankings" class="rankingslabel"><i class="fa fa-trophy" style="cursor: pointer"></i> <label style="cursor: pointer">Rankings</label></a>
        ...
        <img src="HELLO_files/asuna.jpg" class="headerprofilepic">
    ...
    <div class="submissiondetails">
        ...
        <label>Submission time : </label> 01-02-2017 19:29 PM<small><small> IST</small></small><br>
        <label>Problem Code : </label> <a href="https://codebuddy.co.in/problems/HELLO">HELLO</a><br>
...
<span class="hljs-function"><span class="hljs-keyword">int</span> <span class="hljs-title">main</span><span class="hljs-params">(<span class="hljs-keyword">void</span>)</span> </span>{
    ...
    <footer id="footer" class="footercontainer" style="top: 26.7333px;">
    ...
    <script src="HELLO_files/email-decode.js"></script><script type="text/javascript" language="javascript">
