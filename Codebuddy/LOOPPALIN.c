...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <script async="" src="LOOPPALIN_files/analytics.js"></script><script src="LOOPPALIN_files/jquery.js"></script>
    <script src="LOOPPALIN_files/bootstrap.js"></script>
    <link href="LOOPPALIN_files/font-awesome.css" rel="stylesheet">
    <link rel="stylesheet" href="LOOPPALIN_files/bootstrap.css">
    <link rel="stylesheet" href="LOOPPALIN_files/default.css">
    <script src="LOOPPALIN_files/highlight.js"></script>
    <link rel="stylesheet" href="LOOPPALIN_files/header.css">
    <link rel="stylesheet" href="LOOPPALIN_files/viewsolution.css">
    <script src="LOOPPALIN_files/anal.js"></script>
...
<div class="effect2">
    <a href="https://codebuddy.co.in/"><img src="LOOPPALIN_files/LogoResize.png" alt="Image Not Found" class="logo2"></a>
    ...
    <a href="https://codebuddy.co.in/ranks/practice" id="headerrankings" class="rankingslabel"><i class="fa fa-trophy" style="cursor: pointer"></i> <label style="cursor: pointer">Rankings</label></a>
        ...
        <img src="LOOPPALIN_files/asuna.jpg" class="headerprofilepic">
    ...
    <div class="submissiondetails">
        ...
        <label>Submission time : </label> 16-06-2017 15:02 PM<small><small> IST</small></small><br>
        <label>Problem Code : </label> <a href="https://codebuddy.co.in/problems/LOOPPALIN">LOOPPALIN</a><br>
...
<span class="hljs-keyword">long</span> <span class="hljs-keyword">long</span> <span class="hljs-keyword">int</span> N;
<span class="hljs-function"><span class="hljs-keyword">int</span> <span class="hljs-title">main</span><span class="hljs-params">()</span> </span>{
	<span class="hljs-keyword">int</span> T;
	<span class="hljs-built_in">scanf</span>(<span class="hljs-string">"%d"</span>,&amp;T);
	<span class="hljs-keyword">while</span>(T--)
	{
	    <span class="hljs-keyword">long</span> <span class="hljs-keyword">long</span> <span class="hljs-keyword">int</span> rev=<span class="hljs-number">0</span>;
	<span class="hljs-keyword">int</span> rem;
	    <span class="hljs-built_in">scanf</span>(<span class="hljs-string">"%lld"</span>,&amp;N);
	    <span class="hljs-keyword">long</span> <span class="hljs-keyword">long</span> <span class="hljs-keyword">int</span> num=N;
	    <span class="hljs-keyword">do</span>{
	    rem=N%<span class="hljs-number">10</span>;
	    rev=rev*<span class="hljs-number">10</span>+rem;
	    N/=<span class="hljs-number">10</span>;
	    }
	    <span class="hljs-keyword">while</span>(N!=<span class="hljs-number">0</span>);
	    <span class="hljs-keyword">if</span>(num==rev)
	    <span class="hljs-built_in">cout</span>&lt;&lt;<span class="hljs-string">"Yes\n"</span>;
	    <span class="hljs-keyword">else</span> 
	    <span class="hljs-built_in">cout</span>&lt;&lt;<span class="hljs-string">"No\n"</span>;
    ...
    <footer id="footer" class="footercontainer" style="top: 26.8333px;">
    ...
    <script src="LOOPPALIN_files/email-decode.js"></script><script type="text/javascript" language="javascript">
