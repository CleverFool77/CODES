...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <script async="" src="APGP_files/analytics.js"></script><script src="APGP_files/jquery.js"></script>
    <script src="APGP_files/bootstrap.js"></script>
    <link href="APGP_files/font-awesome.css" rel="stylesheet">
    <link rel="stylesheet" href="APGP_files/bootstrap.css">
    <link rel="stylesheet" href="APGP_files/default.css">
    <script src="APGP_files/highlight.js"></script>
    <link rel="stylesheet" href="APGP_files/header.css">
    <link rel="stylesheet" href="APGP_files/viewsolution.css">
    <script src="APGP_files/anal.js"></script>
...
<div class="effect2">
    <a href="https://codebuddy.co.in/"><img src="APGP_files/LogoResize.png" alt="Image Not Found" class="logo2"></a>
    ...
    <a href="https://codebuddy.co.in/ranks/practice" id="headerrankings" class="rankingslabel"><i class="fa fa-trophy" style="cursor: pointer"></i> <label style="cursor: pointer">Rankings</label></a>
        ...
        <img src="APGP_files/asuna.jpg" class="headerprofilepic">
    ...
    <div class="submissiondetails">
        ...
        <label>Submission time : </label> 16-06-2017 17:18 PM<small><small> IST</small></small><br>
        <label>Problem Code : </label> <a href="https://codebuddy.co.in/problems/APGP">APGP</a><br>
...
<span class="hljs-function"><span class="hljs-keyword">int</span> <span class="hljs-title">main</span><span class="hljs-params">()</span> </span>{
	<span class="hljs-keyword">int</span> a,b,c,count1=<span class="hljs-number">0</span>,count2=<span class="hljs-number">0</span>;
<span class="hljs-built_in">scanf</span>(<span class="hljs-string">"%d %d %d"</span>,&amp;a,&amp;b,&amp;c);
<span class="hljs-keyword">if</span>((a+c)==(<span class="hljs-number">2</span>*b))
count1=<span class="hljs-number">1</span>;
<span class="hljs-keyword">if</span>((a*c)==(b*b))
count2=<span class="hljs-number">1</span>;

<span class="hljs-keyword">if</span>(count1==<span class="hljs-number">1</span>&amp;&amp;count2==<span class="hljs-number">1</span>)
<span class="hljs-built_in">cout</span>&lt;&lt;<span class="hljs-string">"Both"</span>;
<span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(count1==<span class="hljs-number">1</span>)
<span class="hljs-built_in">cout</span>&lt;&lt;<span class="hljs-string">"AP"</span>;
<span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(count2==<span class="hljs-number">1</span>)
<span class="hljs-built_in">cout</span>&lt;&lt;<span class="hljs-string">"GP"</span>;
<span class="hljs-keyword">else</span>  
<span class="hljs-built_in">cout</span>&lt;&lt;<span class="hljs-string">"None"</span>;
    ...
    <footer id="footer" class="footercontainer" style="top: 26.6667px;">
    ...
    <script src="APGP_files/email-decode.js"></script><script type="text/javascript" language="javascript">
